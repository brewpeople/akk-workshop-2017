...
\begin{frame}{Geschichtlicher Abriss}
  \begin{table}
    ...
    \begin{tabular}{@{\,}r <{\hskip 2pt} !{\timelinesep}
      ...
      Mittelalter & Verfeinerung der Braukunst in Klöstern
        \begin{minipage}[t]{\linewidth}
          \begin{itemize}
            \item Zusatz von Eichenrinde oder Kräutern zur Verbesserung von
  ...
  \end{table}
\end{frame}
\begin{frame}{Entwicklung untergäriger Biere}
  \begin{table}
    \renewcommand\arraystretch{1.4}\arrayrulecolor{red}
    \begin{tabular}{@{\,}r <{\hskip 2pt} !{\timelinesep}
      >{\raggedright\arraybackslash}p{8.5cm}}
      \addlinespace[1.5ex]
      14. Jhd. & Untergäriges Bier, zunächst nur in kalten Regionen oder im Winter möglich\\
...
%  \begin{itemize}
%    \item großes Gefäß zum Kochen (z.B. Einkocher, 30 l)
%    \item Läuterbottich mit Läuterblech
%    \item Bierwürzespindel
%    \item Spindelzylinder (optional) oder hohes Glas
%    \item großer Kochlöffel
%    \item großes Küchenmesser
%    \item Küchensieb
%    \item Wasserkocher (optional)
%    \item Schaumlöffel (optional)
%    \item Gärfass
%    \item Küchenthermometer
%    \item Messbecher
%    \item Küchenwaage
%    \item 1-2 Kochtöpfe
%    \item sauberes abgekochtes Küchentuch
%    \item Bügelflaschen
%    \item Silikonschlauch (optional)
%  \end{itemize}
%\end{frame}
