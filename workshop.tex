...
\begin{frame}{Geschichtlicher Abriss}
  \begin{itemize}
  	...
  	%Archäologische Funde im fruchtbaren Halbmond gehen zurück bis 10.000 v. Chr.
  	\begin{itemize}
  	...
  	\item 1870: Entwicklung der Kältemaschine von \textit{Carl von Linde} wodurch die flächendeckende Herstellung untergäriger Biere möglich wurde
  \end{itemize}
